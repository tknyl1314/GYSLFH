...
import proj4j.datum.Datum;
import proj4j.datum.Ellipsoid;
import proj4j.proj.AiryProjection;
import proj4j.proj.AitoffProjection;
import proj4j.proj.AlbersProjection;
import proj4j.proj.AugustProjection;
import proj4j.proj.BipolarProjection;
import proj4j.proj.BoggsProjection;
import proj4j.proj.BonneProjection;
import proj4j.proj.CassiniProjection;
import proj4j.proj.CentralCylindricalProjection;
import proj4j.proj.CollignonProjection;
import proj4j.proj.CrasterProjection;
import proj4j.proj.DenoyerProjection;
import proj4j.proj.Eckert1Projection;
import proj4j.proj.Eckert2Projection;
import proj4j.proj.Eckert4Projection;
import proj4j.proj.Eckert5Projection;
import proj4j.proj.Eckert6Projection;
import proj4j.proj.EquidistantAzimuthalProjection;
import proj4j.proj.EquidistantConicProjection;
import proj4j.proj.EulerProjection;
import proj4j.proj.FaheyProjection;
import proj4j.proj.FoucautProjection;
import proj4j.proj.FoucautSinusoidalProjection;
import proj4j.proj.GallProjection;
import proj4j.proj.GnomonicAzimuthalProjection;
import proj4j.proj.GoodeProjection;
import proj4j.proj.HammerProjection;
import proj4j.proj.HatanoProjection;
import proj4j.proj.KavraiskyVProjection;
import proj4j.proj.LagrangeProjection;
import proj4j.proj.LambertAzimuthalEqualAreaProjection;
import proj4j.proj.LambertConformalConicProjection;
import proj4j.proj.LambertEqualAreaConicProjection;
import proj4j.proj.LandsatProjection;
import proj4j.proj.LarriveeProjection;
import proj4j.proj.LaskowskiProjection;
import proj4j.proj.LongLatProjection;
import proj4j.proj.LoximuthalProjection;
import proj4j.proj.McBrydeThomasFlatPolarParabolicProjection;
import proj4j.proj.McBrydeThomasFlatPolarQuarticProjection;
import proj4j.proj.McBrydeThomasFlatPolarSine2Projection;
import proj4j.proj.MercatorProjection;
import proj4j.proj.MillerProjection;
import proj4j.proj.MolleweideProjection;
import proj4j.proj.Murdoch1Projection;
import proj4j.proj.Murdoch2Projection;
import proj4j.proj.Murdoch3Projection;
import proj4j.proj.NellProjection;
import proj4j.proj.NicolosiProjection;
import proj4j.proj.ObliqueMercatorProjection;
import proj4j.proj.ObliqueStereographicAlternativeProjection;
import proj4j.proj.OrthographicAzimuthalProjection;
import proj4j.proj.PerspectiveConicProjection;
import proj4j.proj.PerspectiveProjection;
import proj4j.proj.PlateCarreeProjection;
import proj4j.proj.PolyconicProjection;
import proj4j.proj.Projection;
import proj4j.proj.PutninsP2Projection;
import proj4j.proj.PutninsP4Projection;
import proj4j.proj.PutninsP5PProjection;
import proj4j.proj.PutninsP5Projection;
import proj4j.proj.QuarticAuthalicProjection;
import proj4j.proj.RectangularPolyconicProjection;
import proj4j.proj.RobinsonProjection;
import proj4j.proj.SinusoidalProjection;
import proj4j.proj.StereographicAzimuthalProjection;
import proj4j.proj.SwissObliqueMercatorProjection;
import proj4j.proj.TransverseCylindricalEqualArea;
import proj4j.proj.TransverseMercatorProjection;
import proj4j.proj.TranverseCentralCylindricalProjection;
import proj4j.proj.UrmaevFlatPolarSinusoidalProjection;
import proj4j.proj.VanDerGrintenProjection;
import proj4j.proj.VitkovskyProjection;
import proj4j.proj.Wagner1Projection;
import proj4j.proj.Wagner2Projection;
import proj4j.proj.Wagner3Projection;
import proj4j.proj.Wagner4Projection;
import proj4j.proj.Wagner5Projection;
import proj4j.proj.Wagner7Projection;
import proj4j.proj.WerenskioldProjection;
import proj4j.proj.WinkelTripelProjection;
