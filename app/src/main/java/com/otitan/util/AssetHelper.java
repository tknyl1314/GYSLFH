...
public class AssetHelper {
	 ...
	 * @param ctx
	 * @param path ��Ҫ���Ƶ���Ŀ¼
	 * @param filename ��Ҫ���Ƶ��ļ���
	 * @throws IOException
	 */
	static public void CopyAsset(Context ctx, File path, String filename,String newname)throws IOException {
		...
		try {
			...
			File file = new File(path.toString() + "/" +newname);
