...
import com.titan.gyslfh.upfireinfo.IUpAlarm;
import com.titan.gyslfh.upfireinfo.UploadAlarmInfoModel;
...
public class AlarmViewModel extends BaseViewModel {
    ...
    //火情状态
    public ObservableField<Map<Integer,String>> isfire=new ObservableField<>();
    //火情状态
    ...
    //已选择图片
    protected List<MediaBean> mediaBeanList;

    protected AlarmInfoInterface alarmInfoInterface;

    public AlarmViewModel(Context context, AlarmInfoInterface alarmInfoInterface, DataRepository dataRepository) {
        mContext=context;
